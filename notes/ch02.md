...
- when a function is called, all the parameters in it are created as variables and value of each argument is copied into the matching parameter slot using copy initialization, this is called pass by value
