...
- so when should we use a halt? almost never, it is a tedious process and exceptions (will be learning about ts later) are better and safer way to handle error cases