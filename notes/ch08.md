...
- - -
- let us consider a case where the confitional is a constant expression (example: the value of `gravity: 9.8`, this is constant throughout the program, the if statement will always evaluate to true), the else statement will never be executed 
